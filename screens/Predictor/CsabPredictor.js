...
const CsabPredictor = ({navigation}) => {
  ...
  return (
    <ScrollView style={{flex:1}}>
      <SafeAreaView style={styles.safe}>
        <View >
          <Text style={{ alignSelf:'center', paddingHorizontal:5, fontSize: hp(4) ,fontWeight: 'bold' , color: '#56CB01',marginTop:50, marginBottom:15, }}>CSAB 2021</Text>
        </View>
        <View>
